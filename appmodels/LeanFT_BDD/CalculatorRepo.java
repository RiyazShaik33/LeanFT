...
public class CalculatorRepo extends AppModelBase {		private CalculatorWindow CalculatorWindow;

	public CalculatorRepo() throws GeneralLeanFtException 
	{
		setName("CalculatorRepo");
			CalculatorWindow = new CalculatorWindow(this);
		rebuildDescriptions();
	}
	
	public CalculatorRepo(TestObject contextTestObject) throws GeneralLeanFtException
	{
		setName("CalculatorRepo");
		...
		public class CalculatorWindow extends WindowNodeBase
	{
			...
			private Btn1 Btn1;
	private Btn2 Btn2;
	private BtnRes BtnRes;
						public CalculatorWindow(AppModelBase applicationModel) throws GeneralLeanFtException
		{
			super(applicationModel);

					Btn1 = new Btn1(this, applicationModel);
		Btn2 = new Btn2(this, applicationModel);
		BtnRes = new BtnRes(this, applicationModel);
		...
		protected com.hp.lft.sdk.stdwin.WindowDescription createDescription() throws GeneralLeanFtException{
			...
			try{
				description = new com.hp.lft.sdk.stdwin.WindowDescription.Builder().ownedWindow(false).childWindow(false).windowClassRegExp("CalcFrame").windowTitleRegExp("Calculator").build();
			}catch(Exception e){
			...
			return description;
				...
				public Btn1 Btn1() { return Btn1; }
		public Btn2 Btn2() { return Btn2; }
		public BtnRes BtnRes() { return BtnRes; }
		
			public class Btn1 extends ButtonNodeBase
	{

		
								public Btn1(TestObject parent, AppModelBase applicationModel) throws GeneralLeanFtException
		{
			super(parent, applicationModel);
		...
		protected com.hp.lft.sdk.stdwin.ButtonDescription createDescription() throws GeneralLeanFtException{
			...
			try{
				description = new com.hp.lft.sdk.stdwin.ButtonDescription.Builder().text("").windowId(135).nativeClass("Button").build();
			}catch(Exception e){
				throw new GeneralLeanFtException(e.getMessage(), e);
			}
			return description;
	...
	public class Btn2 extends ButtonNodeBase
	{

		
								public Btn2(TestObject parent, AppModelBase applicationModel) throws GeneralLeanFtException
		{
			super(parent, applicationModel);
		...
		protected com.hp.lft.sdk.stdwin.ButtonDescription createDescription() throws GeneralLeanFtException{
			com.hp.lft.sdk.stdwin.ButtonDescription description = null; 
			try{
				description = new com.hp.lft.sdk.stdwin.ButtonDescription.Builder().text("").windowId(136).nativeClass("Button").build();
			}catch(Exception e){
				throw new GeneralLeanFtException(e.getMessage(), e);
			}
			return description;
	...
	public class BtnRes extends StaticNodeBase
	{

		
								public BtnRes(TestObject parent, AppModelBase applicationModel) throws GeneralLeanFtException
		{
			super(parent, applicationModel);
		...
		protected com.hp.lft.sdk.stdwin.StaticDescription createDescription() throws GeneralLeanFtException{
			...
			try{
				description = new com.hp.lft.sdk.stdwin.StaticDescription.Builder().windowId(150).nativeClass("Static").build();
			}catch(Exception e){
				throw new GeneralLeanFtException(e.getMessage(), e);
			}
			return description;
	...
	public abstract class StaticNodeBase extends AppModelNodeBase<com.hp.lft.sdk.stdwin.Static, com.hp.lft.sdk.stdwin.StaticDescription> implements com.hp.lft.sdk.stdwin.Static
	{		
		public StaticNodeBase(TestObject parent, AppModelBase applicationModel) throws GeneralLeanFtException
		{
			super(parent, applicationModel);
		}
